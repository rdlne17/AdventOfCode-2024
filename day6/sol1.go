...
func solve_puzzle(puzzle_map map[int][]rune, current_x, current_y, num_rotations int) [][]int {
	...
	if puzzle_map[current_x][current_y] == '#' {
		...
		return slices.Concat(tmp_coords, solve_puzzle(puzzle_map, current_x, current_y, num_rotations+1))
	}
	...
	case 0: // Going up
		tmp_coords = slices.Concat(tmp_coords, solve_puzzle(puzzle_map, current_x-1, current_y, num_rotations))

	case 1: // Going right
		tmp_coords = slices.Concat(tmp_coords, solve_puzzle(puzzle_map, current_x, current_y+1, num_rotations))
...
func matrix_eq(val1, val2 []int) bool {
	return val1[0] == val2[0] && val1[1] == val2[1]
}

func matrix_sort(val1, val2 []int) int {
	if val1[0] < val2[0] || val1[0] == val2[0] && val1[1] < val2[1] {
		return 1
